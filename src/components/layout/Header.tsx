						...
						<div className="mobile-menu-content">
							<div className="mobile-menu-header">
								<Link to="/" onClick={() => setMobileMenuOpen(false)}>
									<img className="mobile-menu-logo" src="/images/logos/new_logo.png" alt="AIXcellence logo" />
								</Link>
								<button
				...
				<div className="container nav">
					<div className="nav-container-left">
						<motion.div className="nav-left" whileHover={{ scale: 1.02 }}>
							<Link to="/">
								<img className="logo" src="/images/logos/new_logo.png" alt="AIXcellence logo" />
							</Link>
						</motion.div>
